      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        > 
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex '>
            ...
            <a href="https://www.linkedin.com/in/prakash-kadam-056621261/" target="_blank">
                <img src={linkedin} alt="" className='w-9 h-9' />
              </a>
            <a href="https://github.com/prakashkadam12"  target="_blank">
                <img src={github} alt="" className='w-9 h-9' />
              </a>
            <a href="https://x.com/PrakashKadam121"  target="_blank">
